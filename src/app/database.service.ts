...
export class DatabaseService {
  ...
  async addCategory(name: string) {
    return this.databaseObj
      ...
      .then(() => {
        return "Gedung created";
      })
      .catch((e) => {
        if (e.code === 6) {
          return "Gedung already exists";
        }
  ...
  async editCategory(name: string, id: number) {
    return this.databaseObj
      ...
      .then(() => {
        return "Gedung updated";
      })
      .catch((e) => {
        if (e.code === 6) {
          return "Gedung already exist";
        }
